...
var Aya = function (_Component) {
    ...
    createClass(Aya, [{
        ...
        value: function render$$1() {
            ...
            var countClass = 'ayaNumber' + (aya.ruku ? ' ruku' : '');
            var id = 's' + aya.sura + '-a' + aya.index;
            var title = aya.ruku ? 'Ruku ' + aya.ruku : '';
            return h(
                'span',
        ...
        value: function getHeader(firstAya, meta) {
            ...
            if (firstAya.bismillah || firstAya.sura === 1) {
                h4 = h(
                    'h4',
                    null,
                    h('img', { src: 'assets/images/bismillah.svg', alt: firstAya.bismillah })
                );
            }
...
var app = render(h(App, { store: store }), document.body, document.getElementById('app'));
